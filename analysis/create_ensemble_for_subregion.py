...
# Pre-processing of each member file:
...
# Now remove unnecessary dimension to some variables
# (redundant information)
# ds['LATITUDE'] = ds['LATITUDE'].isel(N_LEVELS=0)
# ds['VARIABLES']= ds['VARIABLES'].isel(N_MEMBER=0)
# ds['ENTRIES']= ds['ENTRIES'].isel(N_MEMBER=0)
# ds['EXTRA']= ds['EXTRA'].isel(N_MEMBER=0)
...
# Put some variables as coordinates:
...
# Save it on disk (shorter if compute was executed):
# ds.to_netcdf('tempo.nc')  # This is very long !
